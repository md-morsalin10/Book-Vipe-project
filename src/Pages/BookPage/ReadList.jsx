...
const ReadList = ({ read }) => {
    const { bookName, image, author, yearOfPublishing, rating, tags, category, totalPages, publisher } = read
    ...
    return (
        ...
        '>
            ...
            <div className='
                ...
                group-hover:bg-green-100/40
                overflow-hidden
            '>
                <img
                    className='
                        object-contain h-30 w-30 rounded-2xl
